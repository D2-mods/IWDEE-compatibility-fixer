...
- Removed fix/tweak for subtledoctor's innate metamagic/sequencers (Tome and Blood mod). The actual fix parts were already added to TnB a long time ago. (Note: Use the SCS version of this tweak if your want bards to gain the level 8 Spell Sequencer. This also lets SCS AI use innate sequencers.)
